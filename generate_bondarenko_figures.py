# file: generate_bondarenko_figure.py
import pandas as pd
import numpy as np
...
tmp = df[:5000]
tmp.plot('time', ['v1','v2','v3','v4','v5','v6','v7','v8','v9','v10'],
        legend=False, ax=axs[0]) 
axs[0].set(title='(a)', xlabel='time', ylabel='output intensity')

# (b) Matrix profile
#df.plot('time', ['v1','v2','v3','v4','v5','v6','v7','v8','v9','v10'],
